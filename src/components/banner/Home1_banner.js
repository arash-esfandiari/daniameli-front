                    ...
                    >
                        <MDBCarouselInner>
                            ...
                            <MDBCarouselItem itemId="2">
                                <MDBView>
                                    <img className="d-block w-100" src="images/ref-stand.png" alt="First slide" />
                                </MDBView>
                                <MDBCarouselCaption>
                                    <div className="container-xl">
                                        <div className="carousel-caption-inner banner2">
                                            <MDBAnimation className="slideInUp" count={1} delay="2s" >
                                                <h2 style={headerStyle} className="ttm-textcolor-darkgrey flipInY">More than <strong className="ttm-textcolor-skincolor" > 7,000</strong> Reference Standards</h2>
                                            </MDBAnimation>
                                            <MDBAnimation className="slideInUp" count={1} delay="2.5s" >
